...
var U="http://localhost:8000/Category";
...
U:"http://localhost:8000/Category"
...
function display(){
$.get(`${U}/getcategory.php`,{},function(data){
...
let  url=`${U}/insertcategory.php?catid=${a}&catname=${b}&picture=${c}`;
console.log(url);
...
let url=`${U}/updatecategory.php?catid=${a}&catname=${b}&picture=${c}`;
$.get(url,{},function(data){
work();
});
...
function remove(i){
let a=i;
let url=`${U}/deletecategory.php?catid=${a}`;
$.get(url,{},function(data){
work();
});
}
...
<h1 class="text-center"> Tourism Categories </h1>
...
return <tr onClick={()=>show(d.catid,d.catname,d.picture,index)} >
