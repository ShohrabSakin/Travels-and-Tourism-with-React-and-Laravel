...
function display(){
$.get(`${U}/getvehicle.php`,{},function(data){
...
let  url=`${U}/insertvehicle.php?vhid=${a}&vhname=${b}&price=${c}&rating=${d}&picture=${g}`;
console.log(url);
...
let url=`${U}/updatevehicle.php?vhid=${a}&vhname=${b}&price=${c}&rating=${d}&picture=${g}`;
$.get(url,{},function(data){
work();
});
...
function remove(i){
let a=i;
let url=`${U}/deletevehicles.php?vhid=${a}`;
$.get(url,{},function(data){
work();
});
}
...
<h1 class="text-center"> Luxurious World Class Vehicle Services </h1>

<div class="row">
<div class="col-sm-2">

<div class="form-group">
<label for="vhid">Vehicle ID</label>
<input type="text" id="vhid" class="form-control"/>
</div>

<div class="form-group">
<label for="vhname">Vehicles</label>
<input type="text" id="vhname" class="form-control"/>
</div>
...
return <tr onClick={()=>show(d.vhid,d.vhname,d.price,d.rating,d.picture,index)} >
...
<td><button type="button"  class="btn btn-danger" onClick={()=>remove(d.vhid)} > Remove </button></td>
